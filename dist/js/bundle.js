...
/***/ "./src/js/brandCards.js":
/*!******************************!*\
  !*** ./src/js/brandCards.js ***!
  \******************************/
/***/ (() => {

const brandButtonShowHide = document.querySelector('.repair-brand-section__button-show-hide');
...
brandButtonShowHide.addEventListener('click', function () {
  const brandCardList = document.querySelectorAll('.repair-brand-section__swiper-card');
...
const calcNeededBrandCard = function () {
  ...
  const tabletMatch = window.matchMedia('((min-width: 768px) and (max-width: 1119px))');
...
/* harmony import */ var _node_modules_swiper_swiper_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../node_modules/swiper/swiper.scss */ "./node_modules/swiper/swiper.scss");
/* harmony import */ var _node_modules_swiper_modules_pagination_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../node_modules/swiper/modules/pagination.scss */ "./node_modules/swiper/modules/pagination.scss");
...
/***/ "./src/js/variousCards.js":
/*!********************************!*\
  !*** ./src/js/variousCards.js ***!
  \********************************/
/***/ (() => {

const variousCardsList = document.querySelectorAll('.repair-various-section__swiper-card');
const buttonVariousShowHide = document.querySelector('.repair-various-section__button-show-hide');
const cardBrandRemover = function (list, count) {
  for (let i = count; i < list.length; i++) {
...
const variousShowAll = function () {
  for (let i = 0; i < variousCardsList.length; i++) {
    variousCardsList[i].classList.remove('repair-various-section__swiper-card--hidden');
  }
};
...
/* harmony import */ var _js_brandCards__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../js/brandCards */ "./src/js/brandCards.js");
/* harmony import */ var _js_brandCards__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_js_brandCards__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _scss_style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../scss/style.scss */ "./src/scss/style.scss");
/* harmony import */ var _variousCards__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./variousCards */ "./src/js/variousCards.js");
/* harmony import */ var _variousCards__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_variousCards__WEBPACK_IMPORTED_MODULE_4__);
